...
@click.option(
    ...
    "--names_path",
    type=click.STRING,
    default=Path("validation-datasets", "torsiondrive-validation-names.json"),
    show_default=True,
...
#        "Null-0.0.3-NAGL": "Null-0.0.3-NAGL",
    ...
    record_names = [
        "ace-ala-gln-ala-nme-rotamer-1",
        "ace-val-ala-val-nme-rotamer-1",
        "ace-val-gly-val-nme-rotamer-1",
        "ace-val-val-val-nme-rotamer-1",
    ]
