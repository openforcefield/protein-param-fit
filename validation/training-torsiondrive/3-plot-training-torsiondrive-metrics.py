...
def main(
    ...
    _plot_rmse(
        rmse_values,
        Path(output_dir, "training-torsiondrive-target-qm-mm-rmse.pdf"),
        figure_size,
        "Capped 1-mer\nRMSE (kcal mol$^{-1}$)",
    ...
    _plot_rmse(
        norm_rmse_values,
        Path(output_dir, "training-torsiondrive-target-qm-mm-norm-rmse.pdf"),
        figure_size,
        "Capped 1-mer\nNormalized RMSE",
        rotate_x_labels=True,
    )
    ...
    _plot_force_field_rmse(
        rmse_values,
        Path(output_dir, "training-force-field-qm-mm-rmse.pdf"),
        figure_size,
        "Capped 1-mer\nRMSE (kcal mol$^{-1}$)",
    ...
    _plot_force_field_rmse(
        norm_rmse_values,
        Path(output_dir, "training-force-field-qm-mm-norm-rmse.pdf"),
        figure_size,
        "Capped 1-mer\nNormalized RMSE",
        dark_background=dark_background,
        rotate_x_labels=True,
